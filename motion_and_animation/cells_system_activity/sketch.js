...
//hint Cell({position, velocity, diameter, life}) 
...
function checkCollision(cell1, cell2)
{
 ...
 if (collisionCell < ((cell1.getDiameter()/2) + (cell2.getDiameter()/2))){
...
function draw() {
  ...
  //change ball colour
  ambientMaterial(random(0,255), random(0,255),random(0,255)); // magenta material
  ...
  //change world colour
  ambientMaterial('red'); // magenta material for subsequent objects
  sphere(width); // this is the border of the world, a little like a "skybox" in video games
  

//draw random numbers of toris 
...
//draw torus and change with a slider
function drawToris(){

  rotateX(frameCount * 0.02);
  rotateY(frameCount * 0.01);
  torus(150,10,detailX.value(),16);
